...
export default function BrandEditForm({ data }: { data: User }) {
  ...
  return (
    <form
      ...
      className="w-full px-6 grid grid-cols-1 divide-y-2 divide-gray-300 lg:py-6 lg:px-0 lg:divide-y-0 lg:divide-x-2 lg:grid-cols-[minmax(0,_2fr)_minmax(0,_1fr)] bg-white rounded-md shadow-md">
      <div className="flex flex-col gap-y-4 py-8 lg:px-8 lg:py-0">
        ...
        <div className="flex flex-col">
          <label
            ...
            className={clsx(
              ...
              {
                "relative flex-col gap-y-4 items-center justify-center border-2 border-dashed text-violet-500 border-violet-500 hover:border-violet-800 hover:text-violet-800 transition-colors duration-300":
                  !avatar,
              }
            )}>
            {avatar ? (
          ...
          {state.errors?.avatar &&
            state.errors.avatar.map((error: string) => (
              <p className="text-xs text-red-700 mt-2" key={error}>
                {error}
              </p>
            ))}
        </div>
        <div className="relative mt-2 flex flex-col">
          <input
            ...
            id="id"
            value={data.id}
            className="block w-full py-2 px-0.5 text-sm text-gray-950 bg-transparent border-1 border-l-0 border-r-0 border-t-0 border-gray-500 focus:outline-none focus:ring-0 focus:border-violet-800 disabled:bg-gray-100 disabled:rounded-sm disabled:cursor-not-allowed transition-colors duration-300 peer"
            placeholder=" "
            required
            disabled
          />
          <label
            htmlFor="id"
            className="absolute text-sm text-gray-500 transform -translate-y-6 scale-75 top-4 left-0.5 origin-top-left z-10 peer-focus:start-0 peer-focus:text-violet-800 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-2 peer-focus:scale-75 peer-focus:-translate-y-6 peer-focus:left-0.5 peer-disabled:bg-white peer-disabled:px-2 peer-disabled:rounded-full duration-300">
            User ID
          </label>
        </div>
        <div className="relative mt-2 flex flex-col">
          <input
            ...
            id="name"
            value={name}
            className="block w-full py-2 px-0.5 text-sm text-gray-950 bg-transparent border-1 border-l-0 border-r-0 border-t-0 border-gray-500 focus:outline-none focus:ring-0 focus:border-violet-800 transition-colors duration-300 peer"
            placeholder=" "
            required
        ...
        <div className="relative mt-2 flex flex-col">
          ...
          <label
            htmlFor="role"
            className="absolute text-sm text-gray-500 transform -translate-y-6 scale-75 top-4 left-0.5 origin-top-left z-10 peer-focus:text-violet-800 after:content-['*'] after:ml-0.5 after:text-red-500 duration-300">
            Role
          </label>
          {state.errors?.role &&
      ...
      <div className="relative w-full h-full">
        <div className="sticky top-0 flex flex-col gap-y-4 py-8 lg:px-8 lg:py-0">
          ...
          <button
            type="submit"
            className="w-full text-violet-50 text-sm font-bold bg-gray-950 py-4 px-2 rounded-md hover:bg-violet-800 transition-colors duration-300">
            Update
          </button>
          <div className="flex flex-col">
            {state.message && (
