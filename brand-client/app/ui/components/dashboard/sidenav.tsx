    ...
    return (
        <div className="flex h-full flex-col p-4 md:p-2">
            ...
            <div className="flex grow flex-row justify-between space-x-2 md:flex-col md:space-x-0 md:space-y-2">
                ...
                <form>
                    <button className="flex h-[48px] w-full grow items-center justify-center gap-2 rounded-md bg-gray-50 p-3 text-sm text-gray-950 font-medium hover:bg-violet-100 hover:text-violet-800 md:flex-none md:justify-start md:p-2 md:px-3">
